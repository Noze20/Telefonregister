...
def huvud_hjälp_meny():
    ...
    """
    HJÄLP_1 = Path(__file__).parent / MAPP / "hjälp1.txt"
    HJÄLP_2 = Path(__file__).parent / MAPP / "hjälp2.txt"
    HJÄLP_3 = Path(__file__).parent / MAPP / "hjälp3.txt"
    HJÄLP_4 = Path(__file__).parent / MAPP / "hjälp4.txt"
...
def start_hjälp():
    HJÄLP_START = Path(__file__).parent / MAPP / "hjälp5.txt"
