...
def välj_register():
    ...
    while True:
        ...
        val = (input("Välj ett register: ")).strip().lower()
...
def välj_register_jämföra():
    ...
    print("Välj två register att jämföra: ")
    ...
    for i in range(1, 3):
        ...
        valt_register = register_dict[val]

        if valt_register == reg1:
            print("Du har redan valt detta register")
            continue
